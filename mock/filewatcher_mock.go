...
func (m *MockFileWatcher) CallOnceSpecific(uniqueID int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CallOnceSpecific", uniqueID)
	ret0, _ := ret[0].(error)
	return ret0
}

// CallOnceSpecific indicates an expected call of CallOnceSpecific.
func (mr *MockFileWatcherMockRecorder) CallOnceSpecific(uniqueID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CallOnceSpecific", reflect.TypeOf((*MockFileWatcher)(nil).CallOnceSpecific), uniqueID)
}

// CallbackSize mocks base method.
func (m *MockFileWatcher) CallbackSize() int {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CallbackSize")
	ret0, _ := ret[0].(int)
	return ret0
}

// CallbackSize indicates an expected call of CallbackSize.
func (mr *MockFileWatcherMockRecorder) CallbackSize() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CallbackSize", reflect.TypeOf((*MockFileWatcher)(nil).CallbackSize))
}

// DeregisterCallback mocks base method.
func (m *MockFileWatcher) DeregisterCallback(uniqueID int64) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "DeregisterCallback", uniqueID)
}

// DeregisterCallback indicates an expected call of DeregisterCallback.
func (mr *MockFileWatcherMockRecorder) DeregisterCallback(uniqueID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeregisterCallback", reflect.TypeOf((*MockFileWatcher)(nil).DeregisterCallback), uniqueID)
}
...
func (m *MockFileWatcher) RegisterCallback(callback func([]byte)) int64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RegisterCallback", callback)
	ret0, _ := ret[0].(int64)
	return ret0
}

// RegisterCallback indicates an expected call of RegisterCallback.
func (mr *MockFileWatcherMockRecorder) RegisterCallback(callback interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RegisterCallback", reflect.TypeOf((*MockFileWatcher)(nil).RegisterCallback), callback)
}
